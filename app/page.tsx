...
import { JiraEventsWidget } from "./dashboard/JiraEventsWidget"; // Import the new component
...
export default async function Dashboard() {
  ...
  // Note: The userId is typically used to look up stored OAuth tokens for the real user.
  // We're using the JIRA_EMAIL secret for this simple integration demo.
